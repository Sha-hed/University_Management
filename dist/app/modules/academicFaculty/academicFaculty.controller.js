...
const getAllAcademicFaculties = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_service_1.AcademicFacultyServices.getAllAcademicFaculties();
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const getSingleAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicFaculty_service_1.AcademicFacultyServices.getSingleAcademicFaculty(facultyId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
